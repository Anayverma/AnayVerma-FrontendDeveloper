...
const RoadMap = () => {
  return (
    <div className="w-full h-[300vh] relative top-[90vh] gradient-bg-fourth">
      <div className="text-transparent bg-clip-text bg-gradient-to-r font-bold from-pink-500 to-purple-500 text-6xl mx-[40%] my-[5%] z-[1000]">
        RoadMap
      </div>
        ...
        <div className="ml-[10%] w-full ">
          ...
          <div className="text-zinc-400 text-2xl">
            <ul className="list-disc ml-4">
              ...
              <li className="my-[1%]">Serum TRON solana tether holo crypto.</li>
